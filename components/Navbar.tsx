...
// --- الشعار (تم تنظيف الكود وإزالة clip-path المسبب للمشاكل) ---
const LogoSVG = () => (
...
export default function Navbar() {
  return (
    <div className="flex justify-center w-full mt-6 px-4 md:px-8">
      {/* IMPORTANT: Grid 3 columns -> Right(Logo) | Center(Links) | Left(Profile+Search) */}
      <nav
        dir="rtl"
...
>
  ...
  <span>الآن</span>
        ...
        <div className="flex items-center gap-4 justify-self-start">
          {/* Profile Picture */}
          <div className="w-[49px] h-[49px] rounded-full border-2 border-[#722ED1] hover:border-esport-primary transition-all cursor-pointer overflow-hidden relative">
            <Image
